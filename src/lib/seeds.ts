...
export const SEED_SCENARIOS: SeedScenario[] = [
  {
    ...
    dimensions: ["precision", "clarity_of_expectations", "empathy"],
    audience: "peer",
    intent: "request",
  },
  {
    ...
    dimensions: ["constructive_feedback", "supportiveness", "empathy"],
  ...
  },
  {
    ...
    dimensions: ["clarity_of_expectations", "precision"],
  ...
  },
  {
    ...
    dimensions: ["empathy", "supportiveness", "clarity_of_expectations"],
    audience: "peer",
  ...
  },
  {
    ...
    dimensions: ["supportiveness", "empathy"],
    audience: "direct_report",
    intent: "check_in",
  },
];
